...
public class VKUser extends VKRequest.VKRequestListener {
    public final static String TAG = "VKUser";

    private Activity activity;

    public VKUser(Activity activity) {
    ...
    public void onComplete(VKResponse response) {
        ...
        if(activity instanceof MainActivity) {
            ...
            mainActivity.setUserProfile(user);
        }
