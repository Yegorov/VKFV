...
public class VKFriends extends VKRequest.VKRequestListener {
    public final static String TAG = "VKFriends";

    private Activity activity;

    public VKFriends(Activity activity) {
    ...
    public void onComplete(VKResponse response) {
        ...
        if(activity instanceof MainActivity) {
            ...
            mainActivity.setFriendsList(users);
        }
